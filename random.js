...
import EditableProfile from "@/components/manager/EditableProfile";
...
{/* Hamburger Menu Modal - UPDATED WITH SUBSCRIPTION */}
<AnimatePresence>
  {showMenu && (
    <>
      <motion.div
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mb-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-4 sm:p-5 text-white">
            <div className="flex items-center justify-between mb-3">
              <div>
                <div className="text-xs opacity-90 mb-1">Current Plan</div>
              ...
              <div>
                ...
                <div className="font-semibold">
                  {selectedGym?.subscription?.endDate 
                    ? new Date(selectedGym.subscription.endDate).toLocaleDateString('en-IN')
                    : 'N/A'
                  }
                </div>
              </div>
              <div className="text-right">
                ...
                <div className="font-bold text-lg">
                  {(() => {
                    ...
                    const now = new Date();
                    const end = new Date(selectedGym.subscription.endDate);
            ...
            <div className="mt-4 pt-4 border-t border-white border-opacity-20">
              ...
              <div className="flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${
                  selectedGym?.subscription?.status === 'active' ? 'bg-green-400' : 'bg-yellow-400'
                }`} />
...
{/* Add these helper components at the bottom of the file, before export */}
      ...
      <div className="px-3 sm:px-4 mt-4 sm:mt-6 grid grid-cols-2 gap-3 sm:gap-4">
        ...
        <button
          ...
          className="bg-gradient-to-br from-teal-500 to-green-500 text-white rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all active:scale-95"
        >
          <div className="flex flex-col items-center justify-center gap-2 sm:gap-3">
            <svg
              className="w-6 h-6 sm:w-7 sm:h-7"
            ...
            <span className="text-sm sm:text-base font-semibold">Managers</span>
          </div>
        </button>
      </div>
      ...
      {/* Profile Modal - EDITABLE VERSION */}
      <AnimatePresence>
        {showProfile && (
          <>
            <motion.div
